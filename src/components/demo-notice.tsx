  ...
  return (
    <div className="flex items-start gap-2 rounded-lg border border-sky-300/15 bg-sky-300/5 px-3 py-2 text-xs text-sky-100">
      ...
      <p className="leading-5">
        ...
        the app. AI insights, alerts and scenarios are educational prototype estimates, not financial advice. Broker
        fee comparisons should be treated as published-fee estimates and verified with the broker. No broker login,
        payment, order placement or real-money trading connection is active.
      </p>
    </div>
  );
}
